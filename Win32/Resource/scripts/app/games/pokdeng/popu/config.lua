...
function pokdengPopuInit()
    ...
    WindowTag.RoomMenuPopu = 1007;
    WindowTag.BrandDescPopu = 1008;
	--配置
	...
	WindowConfigMap[WindowTag.RoomMenuPopu] 		= {"app.games.pokdeng.popu.roomMenuPopu", "menuPopu", 220, true, true, true, true, "app.view.games.pokdeng."}
	WindowConfigMap[WindowTag.BrandDescPopu] 		= {"app.games.pokdeng.popu.brandDescPopu", "brandDescPopu", 220, true, true, true, true, "app.view.games.pokdeng."}
