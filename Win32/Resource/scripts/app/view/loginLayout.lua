loginLayout=
{
	name="loginLayout",type=0,typeName="View",time=0,x=0,y=0,width=720,height=1280,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
		name="img_bg",type=1,typeName="Image",time=108906194,x=0,y=0,width=720,height=1280,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopRight,file="login/img_bg.png",
		{
			...
			{
				name="btn_login_vistor",type=1,typeName="Button",time=0,x=3,y=440,width=512,height=106,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,file="login/btn_login_vistor.png"
			},
			{
				name="btn_login_fb",type=1,typeName="Button",time=0,x=5,y=280,width=512,height=106,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,file="login/btn_login_fb.png",
				{
					name="Image16",type=1,typeName="Image",time=0,x=10,y=-10,width=109,height=51,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopRight,file="login/fb_sub.png"
				}
			},
			{
				name="text_tip",type=4,typeName="Text",time=0,x=0,y=12,width=443.35,height=100,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,fontSize=30,textAlign=kAlignBottom,colorRed=255,colorGreen=249,colorBlue=202,string=[[ล็อกอินบัญชี FB สินทรัพย์ปลอดภัยกว่า]],colorA=1
			}
		},
		{
