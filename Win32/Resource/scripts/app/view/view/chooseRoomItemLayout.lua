local chooseRoomItemLayout=
{
	name="chooseRoomItemLayout",type=0,typeName="View",time=0,x=0,y=0,width=265,height=303,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,
	{
