...
//    }
     ...
     *         sb.toString())+"lk;ajsd$123!@S2iasf"); Log.d("getSig",
...
//    }
    ...
    public static String getDayTimeStamp(int day) {
        ...
        try {
            ...
            Log.e(TAG, "getDayTimeStamp error", e);
        }
        return time;
    }
