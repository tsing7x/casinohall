...
public class SimUtils {
    ...
    public static String getOperatorName() {
        TelephonyManager telephonyManager = (TelephonyManager) Game.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
        String operatorName = "";
    ...
    public static boolean haveSimCard() {
        TelephonyManager telephonyManager = (TelephonyManager)
                Game.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getAirplaneMode(){
        int isAirplaneMode = Settings.System.getInt(Game.getInstance().getContentResolver(),
    ...
    public static String getSimOperatorCode() {
        ...
        String code = "";
        TelephonyManager tmManager = (TelephonyManager) Game.getInstance()
