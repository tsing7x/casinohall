...
NativeEvent.callActCenter = function(self, param)
	JLog.d("NativeEvent.callActCenter.param :======", param)
end

NativeEvent.actCenterSwitchSvr = function(self, param)
	-- body
	JLog.d("NativeEvent.actcenterSwitchSvr.param :======", param)
end

NativeEvent.actCenterSetSkin = function(self, param)
	-- body
	JLog.d("NativeEvent.actcenterSetSkin.param :======", param)
end

NativeEvent.actCenterDisplay = function(self)
	-- body
	JLog.d("NativeEvent.actcenterDisplay Called!")
end

NativeEvent.actCenterDisplayAct = function(self, param)
	-- body
	JLog.d("NativeEvent.actcenterDisplayAct.param :==========", param)
end

NativeEvent.actCenterDisplayRelate = function(self, param)
	-- body
	JLog.d("NativeEvent.actcenterDisplayRelate.param :==========", param)
end

NativeEvent.actCenterClearCache = function(self)
	-- body
	JLog.d("NativeEvent.actCenterClearCache Called!")
end
