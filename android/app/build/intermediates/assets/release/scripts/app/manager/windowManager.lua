...
WindowConfigMap = {
	...
	[WindowTag.FeedbackPopu] = {"app.popu.lobby.FeedBackPopu", "popu.lobby.feedBackPopu", 220, true, true, true, true},
	...
	[WindowTag.SpeakerPopu] = {"app.popu.lobby.SuonaUsagePopu", "popu.room.speaker.speakerPopu", 221, true, false, true,true},
