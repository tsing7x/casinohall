local gameBtn=
{
	name="gameBtn",type=0,typeName="View",time=0,x=0,y=0,width=580,height=484,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,
	{
		name="bgBtn",type=1,typeName="Button",time=0,x=390,y=253,width=580,height=484,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,file="common/blank.png",
		{
