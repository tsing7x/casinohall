local pokdengLayout=
{
	name="pokdengLayout",type=0,typeName="View",time=0,x=0,y=0,width=720,height=1280,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
		...
		{
			name="btn_back",type=1,typeName="Button",time=0,x=10,y=10,width=63,height=60,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,file="games/common/btn_back.png"
		},
		{
	...
	},
	{
		...
		{
			name="view_info",type=0,typeName="View",time=0,x=150,y=111.05,width=147,height=100,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,
			{
				name="text_round",type=4,typeName="Text",time=0,x=-2,y=0,width=118.55,height=30,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,fontSize=24,textAlign=kAlignTopLeft,colorRed=5,colorGreen=72,colorBlue=32,string=[[局数：0/10]],colorA=1
			},
			{
				name="text_baseAnte",type=4,typeName="Text",time=0,x=-2,y=29,width=118.55,height=30,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,fontSize=24,textAlign=kAlignTopLeft,colorRed=5,colorGreen=72,colorBlue=32,string=[[底注：100]],colorA=1
			},
			{
				name="text_roomCode",type=4,typeName="Text",time=0,x=-2,y=58,width=150,height=30,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,fontSize=24,textAlign=kAlignTopLeft,colorRed=5,colorGreen=72,colorBlue=32,string=[[口令：123456]],colorA=1
			}
		},
		{
