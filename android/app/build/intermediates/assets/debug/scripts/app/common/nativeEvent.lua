...
function NativeEvent:onActcenterCallback(result)
	JLog.d("NativeEvent:onActcenterCallback.result :", result)
end

function NativeEvent:onActcenterSwicthSvrCallback(result)
	-- body
	JLog.d("NativeEvent:onActcenterSwicthSvrCallback.result :", result)
end

function NativeEvent:onActcenterSetSkinCallback(result)
	-- body
	JLog.d("NativeEvent:onActcenterSetSkinCallback.result :", result)
end

function NativeEvent:onActcenterDisplayCallback(result)
	-- body
	JLog.d("NativeEvent:onActcenterDisplayCallback.result :", result)
end

function NativeEvent:onActcenterDisplayActCallback(result)
	-- body
	JLog.d("NativeEvent:onActcenterDisplayActCallback.result :", result)
end

function NativeEvent:onActcenterDisplayRelateCallback(result)
	-- body
	JLog.d("NativeEvent:onActcenterDisplayRelateCallback.result :", result)
end

function NativeEvent:onActcenterClearCacheCallback(result)
	-- body
	JLog.d("NativeEvent:onActcenterClearCacheCallback.result :", result)
end
...
NativeEvent.callEventFuncMap = {
	...
	[kActCenter]             = NativeEvent.onActcenterCallback,
	[kActcenterSwicthSvr]    = NativeEvent.onActcenterSwicthSvrCallback,
	[kActcenterSetSkin]      = NativeEvent.onActcenterSetSkinCallback,
	[kActcenterDisplay]      = NativeEvent.onActcenterDisplayCallback,
	[kActcenterDisplayAct]   = NativeEvent.onActcenterDisplayActCallback,
	[kActcenterDisplayRelate] = NativeEvent.onActcenterDisplayRelateCallback,
	[kActcenterClearCache]   = NativeEvent.onActcenterClearCacheCallback,
